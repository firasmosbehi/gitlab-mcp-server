...
export const gitlabListMergeRequestNotesTool: ToolDef<typeof Schema, unknown> = {
  name: "gitlab_list_merge_request_notes",
  description: "List merge request notes (comments) for a GitLab merge request.",
  access: "read",
  inputSchema: {
    type: "object",
  ...
  async handler(args, ctx) {
    return ctx.gitlab.listMergeRequestNotes(args.project, args.iid, {
      page: args.page,
