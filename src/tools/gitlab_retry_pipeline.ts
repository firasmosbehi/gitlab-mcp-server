...
export const gitlabRetryPipelineTool: ToolDef<typeof Schema, unknown> = {
  name: "gitlab_retry_pipeline",
  description: "Retry a GitLab pipeline by pipeline ID.",
  access: "write",
  inputSchema: {
    type: "object",
  ...
  async handler(args, ctx) {
    ...
    return ctx.gitlab.retryPipeline(args.project, args.pipeline_id);
  },
};
