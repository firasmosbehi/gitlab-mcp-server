...
export const gitlabCancelJobTool: ToolDef<typeof Schema, unknown> = {
  name: "gitlab_cancel_job",
  description: "Cancel a GitLab CI job by job ID.",
  access: "write",
  inputSchema: {
    type: "object",
  ...
  async handler(args, ctx) {
    ...
    return ctx.gitlab.cancelJob(args.project, args.job_id);
  },
};
