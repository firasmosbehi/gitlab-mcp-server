...
export const gitlabListMergeRequestDiscussionsTool: ToolDef<typeof Schema, unknown> = {
  name: "gitlab_list_merge_request_discussions",
  description: "List merge request discussions (threads) for a GitLab merge request.",
  access: "read",
  inputSchema: {
    type: "object",
  ...
  async handler(args, ctx) {
    return ctx.gitlab.listMergeRequestDiscussions(args.project, args.iid, {
      page: args.page,
