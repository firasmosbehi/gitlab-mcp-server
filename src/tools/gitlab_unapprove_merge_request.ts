...
export const gitlabUnapproveMergeRequestTool: ToolDef<typeof Schema, unknown> = {
  name: "gitlab_unapprove_merge_request",
  description: "Remove your approval from a GitLab merge request (API-only).",
  access: "write",
  inputSchema: {
    type: "object",
  ...
  async handler(args, ctx) {
    ...
    return ctx.gitlab.unapproveMergeRequest(args.project, args.iid, { sha: args.sha });
  },
};
