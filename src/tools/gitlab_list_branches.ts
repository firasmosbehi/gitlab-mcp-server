...
export const gitlabListBranchesTool: ToolDef<typeof Schema, unknown> = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      search: { type: "string", description: "Optional branch name search query." },
  ...
  async handler(args, ctx) {
    return ctx.gitlab.listBranches({
